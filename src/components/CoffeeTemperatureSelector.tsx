      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-2 bg-white dark:bg-olive-dark/50 border-2 border-coffee/50 dark:border-caramel/30 rounded-lg text-olive-dark dark:text-cream placeholder-olive/50 dark:placeholder-caramel/50 focus:outline-none focus:border-coffee focus:ring-2 focus:ring-coffee/20"
          >
          ...
          {selectedCoffeeId && coffeeService.getCoffee(selectedCoffeeId) && (
            <div className="mt-3">
              ...
              {coffeeService.getCoffee(selectedCoffeeId)?.description && (
                <p className="text-xs text-olive/80 dark:text-caramel/70">
                  {coffeeService.getCoffee(selectedCoffeeId)?.description}
                </p>
              )}
            </div>
