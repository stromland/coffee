...
export const defaultBrewMethods: BrewMethod[] = [
  // 4:6 Method variants
  {
    ...
    drawdownTime: 75,
    pours: [
      { percentage: 16.67, timeSeconds: 0, description: "40% phase - affects sweetness" },
      { percentage: 23.33, timeSeconds: 45, description: "40% phase - affects sweetness" },
      { percentage: 30, timeSeconds: 90, description: "60% phase - affects strength" },
      { percentage: 30, timeSeconds: 135, description: "60% phase - affects strength" },
    ],
    isDefault: true,
    isCustom: false,
  },
  {
    ...
    drawdownTime: 90,
    pours: [
      { percentage: 20, timeSeconds: 0, description: "40% phase - affects sweetness" },
      { percentage: 20, timeSeconds: 45, description: "40% phase - affects sweetness" },
      { percentage: 20, timeSeconds: 90, description: "60% phase - affects strength" },
      { percentage: 20, timeSeconds: 120, description: "60% phase - affects strength" },
      { percentage: 20, timeSeconds: 150, description: "60% phase - affects strength" },
    ],
    isDefault: true,
    isCustom: false,
  },
  {
    ...
    drawdownTime: 60,
    pours: [
      { percentage: 40, timeSeconds: 0, description: "40% phase - affects sweetness" },
      { percentage: 30, timeSeconds: 60, description: "60% phase - affects strength" },
      { percentage: 30, timeSeconds: 120, description: "60% phase - affects strength" },
    ],
    isDefault: true,
    isCustom: false,
  },
  // James Hoffmann method
  {
    ...
    drawdownTime: 70,
    pours: [
      { percentage: 20, timeSeconds: 0, description: "Bloom - swirl gently at 10-15s" },
      { percentage: 20, timeSeconds: 45, description: "Continue pouring" },
      { percentage: 20, timeSeconds: 70, description: "Continue pouring" },
      { percentage: 20, timeSeconds: 90, description: "Continue pouring" },
      { percentage: 20, timeSeconds: 110, description: "Final pour - swirl at 2:00" },
    ],
    isDefault: true,
    isCustom: false,
  },
